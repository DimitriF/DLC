##' Function to launch the tlc_var_selector app
##'
...
##' @examples
##' run.tlc_var_selector()
##' @export
##'

run.tlc_var_selector <- function(port=NULL) {
  appDir <- system.file("shinyapps", "tlc_var_selector", package = "DLC")
  if (appDir == "") {
