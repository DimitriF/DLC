...
library(shiny)
library(DLC)
source('tlc_RBM_classification.R')
...
ui <- fluidPage(
  ...
  tlc_RBM_classificationUI('tlc_RBM_classification')
)

server <- function(input,output,session){
  tlc_RBM_classification <- callModule(tlc_RBM_classificationServer,id='tlc_RBM_classification')
}
